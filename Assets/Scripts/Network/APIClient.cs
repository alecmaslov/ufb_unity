...
using System.Diagnostics; // Don't forget to import this at the top of your file
...
namespace UFB.Network
{
    public class ApiClient
    {
        ...
        {
            get { return _protocol + _baseUrl + ":" + _port; }
        }
        ...
        public async Task<T> Get<T>(string endpoint)
        {
            ...
            UnityEngine.Debug.Log($"=> APIClient [GET]: {APIUrl}{endpoint}");
